...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-full flex flex-col items-center justify-center overflow-hidden rounded-2xl"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative w-full max-w-4xl h-full flex items-end pb-24 md:pb-10 justify-center">
        <div
        ...
        >
          ...
          <div className="absolute w-60 h-60 md:w-96 md:h-96 rounded-full border border-border/30"></div>
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, hsl(var(--foreground) / 0.15) 0%, hsl(var(--foreground) / 0) 70%)`,
                    width: "56px",
                    height: "56px",
                    left: "-8px",
                    top: "-8px",
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 bg-card/95 backdrop-blur-lg border-border shadow-xl shadow-foreground/5 overflow-visible">
                      ...
                      {item.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1 mb-2">
                          {item.tags.map((tag) => (
                            <Badge
                              key={tag}
                              className="px-2 text-xs text-primary-foreground bg-primary border-primary"
                            >
                              {tag}
                            </Badge>
                          ))}
                    ...
                    <CardContent className="text-xs text-muted-foreground pb-5 md:pb-6">
                      <p>{item.content}</p>
